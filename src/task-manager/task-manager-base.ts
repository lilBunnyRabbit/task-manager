...
export interface TaskManagerEvents<TParsed> extends Record<PropertyKey, unknown> {
  /**
 ...
 */
export class TaskManagerBase<TParsed> extends EventEmitter<TaskManagerEvents<TParsed>> {
  // Status
